 ...
 *
 * 		SYNSNOOP is distributed in the hope that it will be useful,
 * 		but WITHOUT ANY WARRANTY; without even the implied warranty of
 * 		MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
 * 		GNU General Public License for more details.

 * 		You should have received a copy of the GNU General Public License
 * 		along with SYNSNOOP. If not, see <http://www.gnu.org/licenses/>.
 *
 */
...
{
	int pos = 0;
  	if (n >= 1<<16) { n >>= 16; pos += 16;} /*printf("\n-1-------\nvalue = %d\n----1-------\n", pos); }*/
  	if (n >= 1<< 8) { n >>=  8; pos +=  8;} /*printf("\n-2-------\nvalue = %d\n----2-------\n", pos); }*/
  	if (n >= 1<< 4) { n >>=  4; pos +=  4;} /*printf("\n-3--------\nvalue = %d\n---3--------\n", pos); }*/
  	if (n >= 1<< 2) { n >>=  2; pos +=  2;} /*printf("\n-4--------\nvalue = %d\n---4--------\n", pos); }*/
  	if (n >= 1<< 1) {           pos +=  1;} /*printf("\n-5-------\nvalue = %d\n----5-------\n", pos); }*/
  	return ((n == 0) ? (-1) : pos);
}
